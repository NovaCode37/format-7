...
const CATEGORIES: Category[] = [
  ...
  },
  {
    key: "calendars",
    title: "Календари",
    tagline: "Бренд — на весь год.",
    desc: "Настольные домики, перекидные настенные, квартальные, карманные и плакатные календари. Полноцветная печать, ламинация, скругление.",
    image: IMG.prodQuarterly,
    from: "от 8 ₽ / шт.",
    specs: ["настольные / настенные", "квартальные", "ламинация"],
  },
  {
    key: "docs",
    title: "Печать документов",
    tagline: "Быстро и аккуратно.",
    desc: "Копирование и печать документов А4/А3, сканирование, ламинирование, брошюровка и переплёт на пружину.",
    image: IMG.prodDocs,
    from: "от 6 ₽ / стр.",
    specs: ["А4 / А3", "копии · сканы", "брошюровка"],
  },
  {
    key: "photo",
    title: "Фотопечать",
    tagline: "Воспоминания в&nbsp;высоком разрешении.",
    desc: "Печать фотографий форматов 10×15, 15×20, 21×30, 30×40 на глянцевой или матовой бумаге. Поля или без полей, упаковка в конверт.",
    image: IMG.polaroid,
    from: "от 22 ₽ / шт.",
    specs: ["10×15 … 30×40", "глянец / мат", "конверты"],
  },
];
        ...
        <div className="grid grid-cols-12 gap-x-6 mb-12 sm:mb-16 items-end">
          ...
          <Reveal className="col-span-12 lg:col-span-5" delay={0.1}>
            <p className="lead text-ink-600">
              Делаем визитки, флаеры, календари, печать документов и&nbsp;фотопечать

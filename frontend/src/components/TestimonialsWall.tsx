...
const REVIEWS = [
  ...
  { name: "Екатерина С.", role: "Фрилансер", text: "Нужна была срочно пачка визиток к встрече. Сделали за час, ещё и привезли в офис." },
  { name: "Игорь Р.", role: "Магазин одежды", text: "Заказываем футболки с принтом каждый месяц. Качество не выгорает после 50 стирок." },
];
